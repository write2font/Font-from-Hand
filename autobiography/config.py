...
CHAPTER_STRUCTURE = [
    {
        ...
        "q_numbers": [],
        "questions": [],
        "guide":     "독자에게 이 사람이 누구인지 소개하는 도입부. 이름, 고향, 태어난 시대 배경을 따뜻하게 풀어주세요.",
    },
    {
        "title":     "뿌리",
        "q_numbers": [],
        "questions": [],
        "guide":     "유년 시절의 감각적인 장면 중심으로 서술하세요. 자주 가던 장소, 집에서 먹던 음식, 동네 풍경, 아끼던 물건 등 구체적인 이미지로 그 시절을 살려내세요.",
    },
    {
        "title":     "꿈의 씨앗",
        "q_numbers": [],
        "questions": [],
        "guide":     "학창 시절과 꿈이 형성되는 시기. 가장 열정을 쏟았던 것, 어린 시절의 꿈, 지금의 자신과 연결되는 선택의 씨앗을 중심으로 서술하세요.",
    },
    {
        "title":     "세상 속으로",
        "q_numbers": [],
        "questions": [],
        "guide":     "사회에 첫발을 내딛고 인연을 맺는 시기. 첫 도전, 중요한 만남, 전환점이 된 선택을 생동감 있는 에피소드로 서술하세요.",
    },
    {
        "title":     "겨울을 지나며",
        "q_numbers": [],
        "questions": [],
        "guide":     "가장 힘들었던 시기와 그것을 버텨낸 힘. 고생했던 기억, 버티게 해준 것, 그 과정에서 얻은 것을 독자에게 울림 있게 서술하세요.",
    },
    {
        "title":     "빛나는 날들",
        "q_numbers": [],
        "questions": [],
        "guide":     "자부심과 성취의 순간들. '이것만큼은 잘했다'고 느끼는 일, 주변에 자랑하고 싶었던 순간, 뿌듯함을 힘 있게 서술하세요.",
    },
    {
        "title":     "에필로그",
        "q_numbers": [],
        "questions": [],
        "guide":     "삶의 지혜와 바람으로 마무리. 살아오며 지켜온 원칙, 닮고 싶은 사람, 앞으로의 꿈, 후대에 전하고 싶은 말을 따뜻하고 묵직하게 마무리하세요.",
    },
]
